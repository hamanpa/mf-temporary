...
from .stp_models import NeuroPSI_STP_asymptotic_first_order, NeuroPSI_STP_asymptotic_second_order, NeuroPSI_STP_dynamic_first_order, NeuroPSI_STP_dynamic_second_order
...
MODELS_REGISTRY = {
    ...
    # asymptotic STP, no dynamics, just a steady-state effective synaptic strength
    "stp_asymptotic.first_order": NeuroPSI_STP_asymptotic_first_order,
    "stp_asymptotic.second_order": NeuroPSI_STP_asymptotic_second_order,

    "stp_dynamic.first_order": NeuroPSI_STP_dynamic_first_order,
    "stp_dynamic.second_order": NeuroPSI_STP_dynamic_second_order,
}
...
STP_MODELS_REGISTRY = {
    "stp_asymptotic.first_order",
    "stp_asymptotic.second_order",
    "stp_dynamic.first_order",
...
TVB_NEUROPSI_EXC_NEURON_MAPPING = {
    "g_L_e": TranslationRule("g_L", sim_unit="nS"),
    "C_m_e": TranslationRule("cm", sim_unit="pF"),
    "E_L_e": TranslationRule("v_rest", sim_unit="mV"),
    "b_e": TranslationRule("b", sim_unit="pA"),
    "a_e": TranslationRule("a", sim_unit="nS"),
    "tau_w_e": TranslationRule("tau_w", sim_unit="ms"),
...
TVB_NEUROPSI_LEGACY_INH_NEURON_MAPPING = {
...
TVB_NEUROPSI_INH_NEURON_MAPPING = {
    "g_L_i": TranslationRule("g_L", sim_unit="nS"),
    "C_m_i": TranslationRule("cm", sim_unit="pF"),
    "E_L_i": TranslationRule("v_rest", sim_unit="mV"),
    "b_i": TranslationRule("b", sim_unit="pA"),
    "a_i": TranslationRule("a", sim_unit="nS"),
    "tau_w_i": TranslationRule("tau_w", sim_unit="ms"),
...
TVB_NEUROPSI_EXC_STATIC_SYNAPSE_MAPPING = {
...
TVB_NEUROPSI_EXC_TSODYKS_SYNAPSE_MAPPING = {
    ...
    "tau_rec_e": TranslationRule("tau_rec", sim_unit="ms"),
    "tau_fac_e": TranslationRule("tau_fac", sim_unit="ms"),
}

TVB_NEUROPSI_INH_STATIC_SYNAPSE_MAPPING = {
    "Q_i": TranslationRule("weight", sim_unit="nS"),
}

TVB_NEUROPSI_INH_TSODYKS_SYNAPSE_MAPPING = {
    "Q_i": TranslationRule("weight", sim_unit="nS"),
    "U_i": TranslationRule("U", sim_unit=""),
    "tau_rec_i": TranslationRule("tau_rec", sim_unit="ms"),
    "tau_fac_i": TranslationRule("tau_fac", sim_unit="ms"),
}
...
def setup_tvb_model(network_params: BiologicalParameters, mf_sim_params: MeanFieldSimulationConfig) -> lab.models.Model:
    ...
    elif model_name in STP_MODELS_REGISTRY:
        exc_neuron_name = network_params.exc_neuron_name
        inh_neuron_name = network_params.inh_neuron_name
        drive_neuron_name = "drive_neuron"
        stim_neuron_name = "stim_neuron"
